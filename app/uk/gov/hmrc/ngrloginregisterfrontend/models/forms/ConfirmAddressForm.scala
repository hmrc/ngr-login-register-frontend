...
final case class ConfirmAddressForm(radioValue: String)

object ConfirmAddressForm extends CommonFormValidators {
  implicit val format: OFormat[ConfirmAddressForm] = Json.format[ConfirmAddressForm]
