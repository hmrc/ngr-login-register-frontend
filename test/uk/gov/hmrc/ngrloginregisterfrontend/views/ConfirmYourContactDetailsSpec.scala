...
class ConfirmYourContactDetailsSpec extends ViewBaseSpec {
  ...
  object Selectors {
    ...
    val title: Int => String = selectorNumber => s"#content > dl > div:nth-child($selectorNumber) > dt"
    val value: Int => String = selectorNumber => s"#content > dl > div:nth-child($selectorNumber) > dd.govuk-summary-list__value"
